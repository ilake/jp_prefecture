...
module JpPrefecture
  ...
  class Prefecture
    ...
    attr_accessor :code, :name, :name_t, :name_e, :name_h, :name_k, :zips, :area
    ...
    def self.build(code, name, name_t, name_e, name_h = nil, name_k = nil, area = nil)
      pref = self.new
    ...
    def self.find(args)
      ...
      self.build(code,
                 names[:name], names[:name_t], names[:name_e],
